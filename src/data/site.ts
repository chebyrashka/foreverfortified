...
export const articles = [
  {
    slug: "roof-revitalization-minnesota-home",
    title: "More Than a Wash: Why Roof Revitalization Is a Smart Investment for Your Minnesota Home",
    category: "Roofing",
    readTime: "8 min read",
    excerpt:
      "How roof revitalization can protect shingles, improve curb appeal, and help Minnesota homeowners delay avoidable replacement.",
    image:
      "/images/service-photos/roof-moss-revitalization.jpg",
    intro: [
    ...
    sections: [
      {
        title: "Roof stains are often a warning sign",
        paragraphs: [
      ...
      {
        title: "Minnesota weather makes roof maintenance matter",
        paragraphs: [
      ...
      {
        title: "Revitalization is different from blasting a roof clean",
        paragraphs: [
      ...
      {
        title: "What a good roof revitalization visit should include",
        paragraphs: [
      ...
      {
        title: "The value is bigger than curb appeal",
        paragraphs: [
      ...
      {
        title: "How often should homeowners think about it?",
        paragraphs: [
      ...
      {
        title: "Questions to ask before hiring someone",
        paragraphs: [
